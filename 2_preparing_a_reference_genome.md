...
3.  If you were going to use GATK for genotyping (which we are not), you would also need a `.dict` file, which can be generated with a program called [`picard`](http://broadinstitute.github.io/picard/).  To do this, run picard like this:
